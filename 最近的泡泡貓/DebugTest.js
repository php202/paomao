...
function runDebugTest() {
  ...
  try {
    ...
    if (typeof getStoreData === 'function') {
      results.checks.push({ name: 'getStoreData', ok: true });
    }
    if (typeof errorData === 'function') {
      results.checks.push({ name: 'errorData', ok: true });
    }
  } catch (e) {
